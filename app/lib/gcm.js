...
(function(service) {
    ...
    var serviceIntent = service.getIntent(),
        ...
        logResult = (function() {
        Ti.API.error("******************* This is the  title in service " + serviceIntent.getStringExtra('title'));
    })(),
    ...
    launcherIntent.putExtra("title", serviceIntent.getStringExtra('title'));
    launcherIntent.putExtra("message", serviceIntent.getStringExtra('message'));
